...
curl -Lo /tmp/kubeseal.tar.gz https://github.com/bitnami-labs/sealed-secrets/releases/download/v"${KUBESEAL_VERSION}"/kubeseal-"${KUBESEAL_VERSION}"-linux-"${DPKG_ARCHITECTURE}".tar.gz && \
